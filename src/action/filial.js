...
export const addFilial = async (filialText, userPhone) => {
  try {
    ...
    const response = await axios.post('https://cargozhibekzholy.kz:3001/api/filial/addFilial', {
      filialText,
      userPhone
    });
...
export const getFilials = async () => {
  try {
    ...
    const response = await axios.get('https://cargozhibekzholy.kz:3001/api/filial/getFilial');
...
export const fetchFilialByUserPhone = async (userPhone) => {
  try {
      const response = await axios.get('https://cargozhibekzholy.kz:3001/api/filial/getFilialByUserPhone', {
          params: {
              userPhone
          }
      });
...
export const deleteFilial = async (filialId) => {
  try {
    const response = await axios.delete(`https://cargozhibekzholy.kz:3001/api/filial/deleteFilial/${filialId}`);
