...
export const addStatus = async (statusText) => {
  ...
  try {
    ...
    const response = await axios.post('https://cargozhibekzholy.kz:3001/api/status/addStatus', {
      statusText
    });
...
export const getStatus = async () => {
  try {
      const response = await axios.get('https://cargozhibekzholy.kz:3001/api/status/getStatus');
...
export const deleteStatus = async (statusId) => {
  try {
    ...
    const response = await axios.delete(`https://cargozhibekzholy.kz:3001/api/status/deleteStatus/${statusId}`);
