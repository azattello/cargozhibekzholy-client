...
const Parcels = () => {
    ...
    useEffect(() => {
        const fetchBookmarks = async () => {
            try {
                const response = await axios.get(`https://cargozhibekzholy.kz:3001/api/bookmark/${userId}/getBookmarks`);
    ...
    useEffect(() => {
        const fetchArchive = async () => {
            try {
                const response = await axios.get(`https://cargozhibekzholy.kz:3001/api/archive/${userId}/getArchive`);
    ...
    const removeBookmark = async (trackNumber) => {
        ...
        if (confirmDelete) {
            try {
                const response = await fetch(`https://cargozhibekzholy.kz:3001/api/archive/${userId}/delete/${trackNumber}`, {
                    method: 'DELETE',
                });
